    ...
    <div class="main">
        ...
        <div class="sidebar2">
            ...
            <div class="menu">
                ...
                <!-- <div> -->
                <ul class="nav nav-pills" id="myTab" role="tablist">
                    <li><a class="active" id="hadir-tab" data-toggle="tab" href="#hadir" role="tab" aria-controls="hadir"
                           aria-selected="true"><span class="hadir">
                                    <img src="assets/images/icons/hadir.svg">
                                </span>
                ...
                <div class="container">
                    <form action="{{route('api.web.input-kinerja.post')}}" class="form-submit-kinerja active-form">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea name="rincian_kinerja" autofocus rows="10" class="form-control" required></textarea>
                    ...
                    <form action="{{route('api.web.input-kinerja.post')}}" class="form-submit-kinerja">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6 date-group">
                                    <label class="mb-2 mt-4">Tgl. Mulai</label>
                                    <input name="tgl_mulai" class="datepicker" autocomplete="off" id="datepicker" required/>
                                    <span class="icon-date"><i class="fas fa-calendar-alt"></i></span>
                                </div>
                                <div class="col-md-6 date-group">
                                    <label class="mb-2 mt-4">Tgl. Berakhir</label>
                                    <input name="tgl_selesai" class="datepicker" autocomplete="off" id="datepicker1" required/>
                                    <span class="icon-date"><i class="fas fa-calendar-alt"></i></span>
                                </div>
                            </div>
