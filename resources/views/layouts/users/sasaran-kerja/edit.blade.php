    ...
    <div class="nav-top-container">
        <div class="nav-top">
            <div class="title-nav float-left">
                ...
                <span class="badge text-white">{{ucfirst(\App\Models\MasterData\Hari::find(date('N'))->nama_hari)}},
                    {{date('d')}} {{ucfirst(\App\Models\MasterData\Bulan::find((int)date('m'))->nama_bulan)}}
                    {{date('Y')}}</span>
            </div>
    ...
    <div class="container-fluid">
        <div class="row wrap-skp">
            <div class="sub-wrap-skp mb-3">
                ...
                <div>
                    <button id="saveSkp" class="btn btn-primary">Update</button>
                </div>
            </div>
              ...
              <form id="formSkp" action="{{ route('sasaran-kerja.update') }}" method="POST">{{ csrf_field() }}
                  ...
                  <div class="bg-white">
                      ...
                      <div class="skp-desc parent-sasaran mt-3" id="sasaran">
                          ...
                          <div class="child-skp">
                              <input type="hidden" name="skpPegawai_id[]" value="{{ $task->id }}">
                              <input type="hidden" name="skp_id[]" value="{{ $task->id_skp }}">
                              <textarea style="border: none" class="form-control values-skp" name="oldSkp[]"
                                  readonly>{{ $task->task }}</textarea>
                              <div class="flex">
                ...
                <div class="bg-white mb-3">
                    ...
                    <div class="skp-distribusi parent-distribusi mt-3" id="distribusi">
                        ...
                        <div class="child-skp">
                            ...
                            <textarea name="skpDistribusi[]" type="text" style="border:none;"
                                class="form-control values-skp" readonly>{{ $task['task'] }}</textarea>
                            <!-- display none here -->
                            <div class="flex">
                                <div class="btn-style gray warning btn-edit-skp" style="border:none;">
                                    <i class="material-icons">edit</i>
